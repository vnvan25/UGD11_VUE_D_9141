<template>
  <v-container>
    ...
    <v-dialog v-model="dialog" persistent max-width="600px">
      <v-card>
        <v-card-title>
          <span class="headline">Layanan Kendaraan Detail</span>
        </v-card-title>
        <v-card-text>
          <v-container>
            <v-row>
              ...
              <v-col cols="12">
                  <v-select v-bind:items="type" v-model="form.type" label="Type*"></v-select>
                <!-- <v-text-field label="Type*" v-model="form.password" type="password" required></v-text-field> -->
              </v-col>
              <!-- <v-col cols="12">
                <v-date-picker label="Created_at*" v-model="form.created_at" required></v-date-picker>
              </v-col> -->
            </v-row>
          </v-container>
